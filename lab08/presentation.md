...
date: 29 октября, 2022, Москва, Россия
...
![Работа алгоритма гаммирования](0.png){ #fig:001 }

## Пример работы программы

![Работа алгоритма взлома ключа](1.png){ #fig:002 }

![Работа алгоритма шифрования и дешивровки](2.png){ #fig:003 }
